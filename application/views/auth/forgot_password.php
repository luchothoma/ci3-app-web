                      ...
                      <div class="col-sm-6 col-sm-offset-3 form-box">
                        <div class="form-top">
                          <div class="form-top-left">
                            <h3><i><b>ConcepcionServicios </b></i><b>S.A</b></h3>
                              <p>Recuperar los datos de mi cuenta</p>
                        ...
                        <div class="form-bottom">
	                    	<form class="login-form" action="http://localhost/EstacionServicios/ModuloAdministrativo/auth/forgot_password" method="post" accept-charset="utf-8">
								<div class="form-group">
                              		<label class="sr-only" for="form-username">Usuario</label>
                                	<input name="identity" value="" id="identity" type="text" placeholder="Usuario..." class="form-username form-control">
                              	</div>

								<button name="submit" type="submit" class="btn btn-lg btn-primary">Recuperar</button>
							</form>
                      </div>
                  </div>
              </div>
