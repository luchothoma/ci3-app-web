 ...
 */
$config['site_title']                 = "Concepcion Servicios S.A.";       // Site Title, example.com
$config['admin_email']                = "vipservicepc@gmail.com"; // Admin Email, admin@example.com
...
$config['lockout_time']               = 60*5;                 // The number of seconds to lockout an account due to exceeded attempts
